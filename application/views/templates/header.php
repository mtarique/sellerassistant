...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/lib/fontawesome/5.13.0/css/all.min.css'); ?>">
    ...
    <script src="<?php echo base_url('assets/lib/fontawesome/5.13.0/js/all.min.js'); ?>"></script>
